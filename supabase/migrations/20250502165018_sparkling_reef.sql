/*
  # Add function to determine editable fields per tab

  1. Changes
    - Add function to determine which fields are editable in each tab
    - Consider user role and item status
    - Support all tabs: inventory, enter_identify, price_verify, depreciation, recovery
    
  2. Security
    - Set search_path for security
    - Use SECURITY DEFINER for function
*/
